...
import demo.webapp.regular.RegularAlphaForGenSuperAlphaUtils;
import org.quartz.Job;
import org.quartz.JobExecutionContext;
import org.quartz.JobExecutionException;

/**
 * Quartz Job for processing Regular Alphas for generating Super Alphas.
 */
public class RegularAlphaForGenSuperJob implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        try {
            ...
            RegularAlphaForGenSuperAlphaUtils.main(new String[]{});
            ...
            e.printStackTrace();
            throw new JobExecutionException("RegularAlphaForGenSuperJob failed", e);
        }
    }
