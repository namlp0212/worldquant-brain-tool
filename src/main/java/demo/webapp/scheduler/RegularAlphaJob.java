...
/**
 * Quartz Job for processing Regular Alphas.
 */
public class RegularAlphaJob implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        try {
            ...
            RegularAlphaUtils.main(new String[]{});
            ...
            e.printStackTrace();
            throw new JobExecutionException("RegularAlphaJob failed", e);
        }
    }
